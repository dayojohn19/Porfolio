...
urlpatterns = [
    ...
    path("view_loaded_dead/<int:id>",
         views.view_loaded_dead, name="view_loaded_dead"),
    path("view_codes/", views.view_codes, name="view_codes"),
    path("view_registered_pigeons/<int:race_id>",
         views.race_registered, name="races_registered"),
